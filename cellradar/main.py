...
from segmentation import iterate_segmentation, export_rois
from training import label_rois, random_train_test_split, train_svm, train_rf, train_logreg
from predicting import iterate_predicting

image_folder = Path('C:/Users/mcanela/Desktop/sample_marc/tdt')
with open("C:/Users/mcanela/Desktop/sample_jose/best_model/best_model_svm.pkl", 'rb') as file:
